...
from codes.GNNConfig import data_args, train_args, model_args
...
def train_GC():
    ...
    input_dim = dataset.num_node_features
    output_dim = int(dataset.num_classes)
    dataloader = get_dataloader(dataset, train_args.batch_size, random_split_flag=False)
...
def test_GC():
    ...
    input_dim = dataset.num_node_features
    output_dim = int(dataset.num_classes)
    dataloader = get_dataloader(dataset, train_args.batch_size, data_args.random_split, data_args.data_split_ratio)
